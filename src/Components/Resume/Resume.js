...
class Resume extends React.Component {
    ...
    zoomIn() {
        ...
        if (currWidth > 1500 && this.state.firstFunnyMessage) {
            alert(
                "You cannot go any further! I mean, you can... but do you really need it that big?"
            );
            this.setState({
            ...
            alert(
                "Dang. You're still going? Look. The code allows for it, but at this point is it really necessary?"
            );
            this.setState({
                secondFunnyMessage: false,
            ...
            alert(
                "Alright. I'm done. Keep going if you want. But I'm THROUGH zooming in for you!"
            );
            this.setState({
                thirdFunnyMessage: false
            });
        ...
        return (
            <div className="Resume">
                <ButtonGroup size="lg">
                    ...
                    >
                        <Dropdown.Item eventKey="1" href={resumePDF} download>
                            as pdf
                        </Dropdown.Item>
                        <Dropdown.Item eventKey="2" href={resumeJPG} download>
                            as jpg
                        </Dropdown.Item>
                        <Dropdown.Item eventKey="3" href={resumeTXT} download>
                            as txt
                        </Dropdown.Item>
                        <Dropdown.Divider />
                        <Dropdown.Item disabled>
                            Not being prompted?
                            <br />
                            Long hold (mobile) or right-click (Desktop)
                            <br />
                            and "Save as..." or "Open in new tab"
                        </Dropdown.Item>
                    </DropdownButton>
                </ButtonGroup>
